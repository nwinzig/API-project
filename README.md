...
* Request
  * Method: post
  * URL: /user/:userId/credentials/:credentialId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: delete
  * URL: /review/:reviewId/image/:imageId
  * Body: none
